...
================================================
Her terminalde Claude'a rol-spesifik mesaj gönderir:
- LEADER → Takım Lideri görevi
- WORKER-1 → Agent görevi
- WORKER-2 → Worker görevi

v2.0 - Window ID ile kesin hedefleme + Rol bazlı mesajlar
ULTRATHINK Edition - 10K GEM
"""
...
class RolePrompterTask(BaseTask):
    ...
    name = "role_prompter"
    description = "Claude'lara RabbitMQ rol ataması yapar"
    version = "2.0.0"  # Window ID + Rol bazlı mesajlar

    # Rol bazlı mesajlar - Her terminal için farklı görev
    # NOT: AppleScript uyumluluğu için apostrophe kullanmıyoruz
    ROLE_PROMPTS = {
    ...
    def execute(self, context: Dict[str, Any]) -> TaskResult:
        """Her terminalde Claude'a ROL-SPESİFİK soru sor - Window ID ile!"""

        print("\n💬 Role Prompter v2.0 (RabbitMQ Rol Atama)...")
